...
// Last updated by Dayu Wang (dwang@stchas.edu) on 2022-06-24
    ...
    */
    ...
    public List_Iterator<T> iterator() {
        return new List_Iterator<T>() {
            // Data fields
            private int leftIndex = -1;  // Index of the left element at current iterator position
            private int rightIndex = 0;  // Index of the right element at current iterator position
            ...
            */
            @Override
            public T next() {
                if (!hasNext()) { throw new NoSuchElementException("Index out of bounds"); }
            ...
            */
            @Override
            public T previous() {
                if (!hasPrevious()) { throw new NoSuchElementException("Index out of bounds"); }
