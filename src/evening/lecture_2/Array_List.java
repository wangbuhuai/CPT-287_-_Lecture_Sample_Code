...
/** An array list without iterators */
public class Array_List<T> {
    // Data fields
    private static final int DEFAULT_CAPACITY = 10;  // Default capacity used when capacity is not specified
    private int capacity;  // Length of the array
    private int numOfItems;  // Number of elements stored in the array list
    private Object[] data;  // Stores elements in the array list.
